...
- The **speech** carries the argument.
...
- a short phrase;
- one image;
- a number or comparison;
- a brief quotation;
- a highlighted portion of a document;
- a simple diagram;
...
- a small word can become large;
- one term can interrupt another;
- a repeated phrase can acquire a changed meaning;
- a single contrasting word can reverse the preceding claim.

Typography is therefore part of the performance, not merely formatting.
...
1. The speaker creates an expectation.
2. The slide confirms, sharpens, or subverts it.
...
- **Fast runs** create energy, accumulation, or comedy.
- **Steady passages** carry explanation.
- **Repetition** establishes a pattern.
...
- what tension or problem will hold attention;
- what evidence or examples are essential;
...
This prevents the deck from becoming a sequence of arbitrary stock images.

### 4. Storyboard in a version-control-friendly format

A plain-text storyboard can contain one slide per block:
...
- slides that require more reading time;
- jokes that need a pause;
- visual references the audience cannot understand quickly;
- places where the speaker is serving the deck rather than the argument.

Revise the speech and slides together.
...
Used well, the method can:

- focus attention on one idea at a time;
- make spoken structure visible;
- give abstract arguments rhythm and emotional shape;
- support analogy, contrast, callback, and humor;
- reduce the temptation to read dense slides aloud;
- create a memorable sense of momentum;
- make a recorded talk remain visually intelligible at modest resolution;
- turn recurring words and images into a shared vocabulary with the audience.
...
The Lessig method is particularly effective for:

- short keynotes and persuasive talks;
- a clear argument with a strong narrative arc;
- concept introductions;
- product or project stories;
- talks that use analogy and visual humor;
- a rehearsed presentation that will be delivered more than once.

Use it selectively for:

- teaching that requires note-taking;
- technical tutorials;
- research results with complex charts;
- meetings that depend on interruption and discussion;
- long sessions;
...
- Can the talk be summarized as one clear argument or change in understanding?
- Does every sequence contribute to that argument?
- Are claims, evidence, analogy, and opinion distinguishable?
- Does the ending resolve or transform the opening?

### Slides

- Does each slide have one dominant job?
- Can its meaning be grasped in the time it remains visible?
- Is every image specific and purposeful?
- Are recurring motifs used consistently?
- Could a complex slide become several simpler states?
- Are important sources and definitions still available?

### Rhythm

- Do transitions coincide with changes in spoken meaning?
- Is there variation between fast sequences and pauses?
- Are jokes given time to land?
- Are there moments when the audience can catch up?
- Would any section improve if the screen went blank?

### Delivery

- Has the complete talk been rehearsed aloud with the deck?
- Can the speaker advance slides without breaking eye contact or vocal flow?
- Are there safe places to shorten the talk?
- Can the core argument survive a technical failure?

### Audience

- Does the opening begin in the audience's world?
- Are unfamiliar terms introduced only when useful?
- Is the pace appropriate for the room and subject?
- Are accessibility needs addressed?
- Is a useful standalone artifact available afterward?

## A concise definition

> The Lessig method treats slides as synchronized visual rhetoric: many simple
